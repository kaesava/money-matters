...
export const ja: DeepStringRecord<typeof en> = {
  ...
  "paydayDrawer": {
    ...
    "reRunWaterfall": "新しい金額でウォーターフォール再計算",
    "amountChangedPrompt": "収入金額が変更されました。ウォーターフォール計算をやり直すか、サープラスで差額を吸収します。",
    "resetEdits": "編集をリセット",
  ...
  "matrix": {
    ...
    "unsaveDialogDescription": "保存を解除すると手動で入力した金額は破棄され、この収入イベントは自動計算に戻ります。続行しますか？",
