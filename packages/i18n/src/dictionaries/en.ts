export const en = {
  ...
  common: {
    ...
    categoryOrAccount: "Category / Bank Account",
  ...
  transactions: {
    ...
    newExpense: {
      ...
      incomeSuccessMessage: "Income recorded successfully!",
    },
  },
  categories: {
    title: "Categories",
    ...
    sections: {
      everydayTitle: "Everyday Spending",
      everydayDesc: "Pooled discretionary funds. Categories specify budget targets, managed at overall pool level.",
      regularTitle: "Regular Bills",
      regularDesc: "Pooled recurring obligations. Categories specify bill targets, managed at overall pool level.",
      goalTitle: "Save Toward (Goals)",
      goalDesc: "Target savings pools managed individually per category.",
      managedAtPoolLevel: "Managed at overall pool level",
      overallPoolBalance: "Overall Pool Balance",
  ...
  landing: {
    ...
    badge: "✨ Smart income allocation system",
    ...
    simTitle: "Experience Payday Split",
    ...
    simulatorTitle: "Experience Payday Split",
    ...
    card1Title: "Automatic Payday Split",
    card1Desc: "No manual distribution needed. Our recommendation engine automatically calculates your upcoming due dates and savings goals.",
    feature1Title: "Automatic Payday Split",
    feature1Desc: "No manual distribution needed. Our recommendation engine automatically calculates your upcoming due dates and savings goals.",
  ...
  subscription: {
    ...
    trialEndedModalBody: "You're now on the free plan. You still have access to your budgets and 90 days of transaction history. Upgrade anytime to unlock full access.",
  ...
  partner: {
    ...
    inviteSubtitle: "Manage your household allocation budget together. Give your partner full read/write visibility.",
    emailLabel: "Partner's Email Address",
    emailPlaceholder: "partner@example.com",
    sendInvite: "Send Household Invite",
    sendingInvite: "Sending Invite…",
    inviteSent: "Invitation Sent! 🎉",
    inviteSentSuccess: "An invitation link has been generated and queued to {email}.",
    acceptTitle: "Joining Household…",
    acceptSubtitle: "Validating your invitation token.",
    acceptSuccessTitle: "Welcome to the Household! 🎉",
    acceptSuccessMessage: "Your account has been linked to the household budget. Redirecting to dashboard…",
    acceptErrorTitle: "Invitation Invalid",
    invalidToken: "Invalid or expired invitation link. Please request a new invitation from the household owner.",
    mismatchedEmail: "Invitation email does not match authenticated user email.",
    goToDashboard: "Go to Dashboard",
    invalidEmailAlertTitle: "Invalid Email",
