...
export function AdvantagesSection() {
  return (
    <section
      id="advantages"
      className="max-w-6xl mx-auto px-6 py-24 flex flex-col gap-14 scroll-mt-14"
      aria-label="Core Financial Engines"
    >
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="p-7 rounded-3xl bg-white border border-slate-200/80 shadow-sm hover:shadow-md transition-all flex flex-col justify-between gap-6">
          <div className="space-y-3">
            ...
            <h3 className="text-lg font-black text-[#1B2B4B]">{t("landing.advantage1Title")}</h3>
            <p className="text-slate-600 text-xs leading-relaxed font-normal">
              {t("landing.advantage1Body")}
            </p>
          </div>
          <div className="p-4 bg-[#F7F8FA] rounded-2xl border border-slate-200/80 space-y-2 text-xs text-slate-600 font-medium">
        ...
        {/* Advantage 2: 5-Level Affordability Engine */}
        <div className="p-7 rounded-3xl bg-white border border-slate-200/80 shadow-sm hover:shadow-md transition-all flex flex-col justify-between gap-6">
          <div className="space-y-3">
            <span className="text-xs font-bold font-mono text-[#2563eb] bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
              {t("landing.advantage2Label")}
            </span>
            <h3 className="text-lg font-black text-[#1B2B4B]">{t("landing.advantage2Title")}</h3>
            <p className="text-slate-600 text-xs leading-relaxed font-normal">
              {t("landing.advantage2Body")}
            </p>
          </div>
          <div className="p-4 bg-[#F7F8FA] rounded-2xl border border-slate-200/80 space-y-2 text-xs font-bold font-mono">
        ...
        <div className="p-7 rounded-3xl bg-white border border-slate-200/80 shadow-sm hover:shadow-md transition-all flex flex-col justify-between gap-6">
          <div className="space-y-3">
            ...
            <h3 className="text-lg font-black text-[#1B2B4B]">{t("landing.advantage3Title")}</h3>
            <p className="text-slate-600 text-xs leading-relaxed font-normal">
